...
export default function LogoGeometricWave() {
  return (
    <div className="relative w-full max-w-[340px] sm:max-w-[480px] lg:max-w-[540px] aspect-[5/4] flex items-center justify-center select-none mx-auto">
      ...
      <div className="relative w-full h-full rounded-2xl border border-[#281450]/10 bg-white/70 backdrop-blur-sm p-4 sm:p-6 shadow-xl shadow-[#281450]/5 flex flex-col justify-between overflow-hidden">
        ...
        <div className="flex items-center justify-between border-b border-gray-100 pb-3 sm:pb-4">
          <div className="flex items-center space-x-2">
            <span className="w-2 sm:w-2.5 h-2 sm:h-2.5 rounded-full bg-[#0A9678]" />
            <span className="text-[10px] sm:text-xs font-mono font-medium text-gray-500 uppercase tracking-widest">
              NW_ARCH_SYSTEM // V3.2
            </span>
          </div>
          <div className="text-[9px] sm:text-[11px] font-mono text-[#0A9678] bg-[#0A9678]/10 px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full font-semibold">
            STATUS: HIGH PERF
          </div>
        </div>
        ...
        <div className="relative my-auto py-2 flex items-center justify-center">
          <svg
            className="w-full h-44 sm:h-56 max-h-[260px] drop-shadow-sm"
            viewBox="0 0 600 320"
            fill="none"
        ...
        <div className="grid grid-cols-3 gap-1.5 sm:gap-2 pt-2.5 sm:pt-3 border-t border-gray-100 text-center">
